...
public:
	...
	motor_stall_max(4), motor_stall_count(0){
		...
		pause_sub = addReconfigurableSubscriber<device_driver_base::SoftwareStop>(device_driver_state::RUNNING, "/pause", 1000, boost::bind(&RoboteqManager::pauseCallback, this, _1));
